...
function kiosk_move_jquery_to_footer()
{
    if (!is_admin()) {
...
add_action('wp_enqueue_scripts', 'kiosk_move_jquery_to_footer');
...
function kiosk_remove_block_library_css()
{
...
add_action('init', 'kiosk_disable_emojis');
...
add_action('wp_ajax_nopriv_kiosk_search_posts', 'kiosk_ajax_search_posts');
